...
interface Props {
  onPaketOner?: (paketId: string) => void
  embedded?: boolean
}

export default function KrediCalculator({ onPaketOner, embedded = false }: Props) {
  ...
  const recommendationBlock = (
    ...
    >
      <p
        className="text-xs font-medium text-rd-primary-600 uppercase tracking-wider mb-2"
        style={{ fontFamily: 'var(--font-rd-display)' }}
      >
        Sana uygun paket
      </p>
