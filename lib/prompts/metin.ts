...
export const YASAKLI_KELIMELER: Record<Platform, string[]> = {
  trendyol: [
...
export const FIYAT_SEGMENT_YONLENDIRME: Record<string, { tr: string; en: string }> = {
  butce: {
...
export const TON_TANIMLARI: Record<string, { tr: string; en: string }> = {
  samimi: {
  ...
  eglenceli: {
    tr: "Enerjik, eğlenceli ve neşeli bir dil kullan. Kısa ve akılda kalıcı cümleler kur. Emojiler uygunsa kullan. Gençlere hitap eder gibi yaz.",
    en: "Use an energetic, fun and playful tone. Write short, catchy sentences. Use emojis where appropriate. Appeal to a younger audience.",
  },
  ciddi: {
    tr: "Olgusal, ciddi ve doğrudan bir dil kullan. Duygusal ifadelerden kaçın. Teknik kesinlik ön planda. Kurumsal güven verir.",
    en: "Use a factual, serious and direct tone. Avoid emotional language. Technical precision is key. Builds institutional trust.",
  },
  lüks: {
    tr: "İşlenmiş, zarif ve sofistike bir dil kullan. Her kelime özenle seçilmiş hissettirmeli. Nadir, özel ve eşsiz vurgula. Kısa ama çarpıcı cümleler.",
    en: "Use refined, elegant and sophisticated language. Every word should feel carefully chosen. Emphasize rarity, exclusivity, uniqueness. Short but striking sentences.",
  },
  minimal: {
    tr: "Sade, temiz ve özlü bir dil kullan. Gereksiz sıfat ve abartıdan kaçın. Az kelimeyle çok şey anlat. Ürünü olduğu gibi, dürüstçe tanıt.",
    en: "Use clean, concise and unadorned language. Avoid unnecessary adjectives and hyperbole. Say more with less. Present the product honestly as it is.",
  },
};

export function kategoriKoduBul(kategoriMetni: string): string | undefined {
...
export function sistemPromptOlustur(
  platform: Platform,
  dil: "tr" | "en",
  ton?: string,
  kategoriKodu?: string,
