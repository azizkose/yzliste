// Türkiye 81 il + ilçe listesi (statik, e-Fatura adres formu için)
// Kaynak: Türkiye İdari Bölünme, plaka kodları TÜİK standardı
...
// İlçeler: il id → ilçe adları listesi (alfabetik)
export const ILCELER: Record<string, string[]> = {
  ...
  '26': ['Alpu', 'Beylikova', 'Çifteler', 'Günyüzü', 'Han', 'İnönü', 'Mahmudiye', 'Mihalgazi', 'Mihallıçcık', 'Odunpazarı', 'Sarıcakaya', 'Seyitgazi', 'Sivrihisar', 'Tepebaşı'],
  ...
  '37': ['Abana', 'Ağlı', 'Araç', 'Azdavay', 'Bozkurt', 'Çatalzeytin', 'Cide', 'Daday', 'Devrekani', 'Doğanyurt', 'Hanönü', 'İhsangazi', 'İnebolu', 'Küre', 'Merkez', 'Pınarbaşı', 'Seydiler', 'Şenpazar', 'Taşköprü', 'Tosya'],
  ...
  '55': ['19 Mayıs', 'Alaçam', 'Asarcık', 'Atakum', 'Ayvacık', 'Bafra', 'Çarşamba', 'Havza', 'İlkadım', 'Kavak', 'Ladik', 'Ondokuzmayıs', 'Salıpazarı', 'Tekkeköy', 'Terme', 'Vezirköprü', 'Yakakent'],
  ...
  '67': ['Alaplı', 'Çaycuma', 'Devrek', 'Gökçebey', 'Kilimli', 'Kozlu', 'Merkez'],
  ...
  '81': ['Akçakoca', 'Cumayeri', 'Çilimli', 'Gölköy', 'Gölyaka', 'Gümusova', 'Kaynaşlı', 'Merkez', 'Yığılca'],
}
