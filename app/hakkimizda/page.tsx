...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      tr: "https://www.yzliste.com/hakkimizda",
      "x-default": "https://www.yzliste.com/hakkimizda",
    },
  },
...
export default function HakkimizdaPage() {
  return (
    <>
      <SiteHeader />
      <main className="min-h-screen bg-rd-neutral-50 py-12 px-4">
        <div className="max-w-2xl mx-auto">

          <Link
            href="/"
            className="text-sm text-rd-neutral-500 hover:text-rd-primary-600 transition-colors"
          >
            ← Ana sayfa
          </Link>
          ...
          <div className="mt-8 mb-10">
            ...
            <h1
              ...
              style={{ letterSpacing: "-0.01em", fontFamily: "var(--font-rd-display)" }}
            >
              yzliste neden var
            </h1>
          </div>
